...
if __name__=="__main__":
    ...
    features_list = [("MFCCs",mfccs),("Centroids",centroids),("Frequency Mean",freq_mean),("Frequency Standard Deviation",freq_sd),("Frequency Median",freq_median),("Frequency Mode",freq_mode),("Dominant Frequency Mean",domfreq_mean),("Dominant Frequency Minimum",domfreq_min),("Dominant Frequency Maximum",domfreq_max),("Dominant Frequency Range",domfreq_range),("Dominant Frequency Median",domfreq_median),("Dominant Frequency Mode",domfreq_mode),("Dominant Frequency",domfreq),("Dominant Frequency 1st Quartile",domfreq_first_quartile),("Dominant Frequency 3rd Quartile",domfreq_third_quartile),("Dominant Frequency Interquartile Range",domfreq_interquartile_range),("Fundamental Frequency Mean",fundfreq_mean),("Fundamental Frequency Minimum",fundfreq_min),("Fundamental Frequency Maximum",fundfreq_max),("Fundamental Frequency",fundfreq),("Fundamental Frequency 1st Quartile",fundfreq_first_quartile),("Fundamental Frequency 3rd Quartile",fundfreq_third_quartile),("Fundamental Frequency Interquartile Range",fundfreq_interquartile_range)] 
